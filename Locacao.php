...
function locarLivro(){
    ...
    try {
        ...
        return 'Erro de conexão com o banco de dados: ' .$erro->getMessage();
    }
...
function alterar(){
    ...
    if ($con->execute()){
            ...
            if($con->rowCount() > 0){                      
                echo "<script>"
                . " alert('Empréstimo de Livro Atualizado com sucesso!');"
                . " window.location.href='view/locacaoview.php?opcao=1'; </script>";        
            }else{
                echo "<script>"
                . " alert('Dados não pode ser Atualizado, informe o Adm!');"
                . " window.location.href='view/locacaoview.php?opcao=1'; </script>";
            }
    }else{
            echo "<script>"
                . " alert('Dados não executados, informe o Adm!');"
                . " window.location.href='view/locacaoview.php?opcao=1'; </script>";
            }
        
    } catch (Exception $ex) {
        return 'Informe o ADM. Erro: ' .$ex->getMessage();
    } 
}
